...
@section('content')
    ...
    <div class="content-section-a">
        <div class="container">
            <h1>
                ...
                <a href="{{url('/admin/articles')}}" class="btn btn-warning btn-sm">Отмена</a>
            </h1>
        </div>
    </div>
    <div class="content-section-b">
        <div class="container">
            ...
            <form class="form-horizontal objectForm" action="/admin/articles" method="post" data-post-action="reload">
