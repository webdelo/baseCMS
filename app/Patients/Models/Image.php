...
class Image extends Eloquent {
     ...
     * @var string
     */
    protected $table = 'patients_images';

    /**
     * @var string
     */
    protected $folder = '/data/images/patients/';
    ...
    {
        if ( !$this->handler ) {
            $this->handler = new PatientImageHandler($this->getOwner());
        }
        return $this->handler;
    }
    ...
    private function getOwner()
    {
        if (!$this->owner) {
            ...
            $this->owner = $patients->find($this->objectId);
        }
